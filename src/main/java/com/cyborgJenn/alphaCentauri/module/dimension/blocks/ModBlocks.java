...
public class ModBlocks {
	...
	public static void initBlocks()
	{
		...
		oreIron      = new GenericBlock(1, Material.ROCK, "ore_iron");
		oreLapis     = new GenericBlock(1, Material.ROCK, "ore_lapis");
		oreCoal      = new GenericBlockdropItem(1, Material.ROCK, "ore_coal", Items.COAL);
		oreDiamond   = new GenericBlockdropItem(1, Material.ROCK, "ore_diamond", Items.DIAMOND);
		oreEmerald   = new GenericBlockdropItem(1, Material.ROCK, "ore_emerald", Items.EMERALD);
		oreRedstone  = new GenericBlockdropItem(1, Material.ROCK, "ore_redstone", Items.REDSTONE);
