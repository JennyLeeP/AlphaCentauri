package com.cyborgJenn.alphaCentauri.module.dimension.chunk;
                    ...
                    for (int h = 0; h < 8; ++h) {
                        ...
                        for (int x = 0; x < 4; ++x) 
                        {
                            ...
                            for (int z = 0; z < 4; ++z) 
                            {
                                ...
                                {
                                    primer.setBlockState(x4 * 4 + x, height32 * 8 + h, z4 * 4 + z, ModBlocks.acStone.getDefaultState());
                                }
                                else if (height32 * 8 + h < sealevel)
                                {
                                    primer.setBlockState(x4 * 4 + x, height32 * 8 + h, z4 * 4 + z, this.oceanBlock);
                                }
                            }
