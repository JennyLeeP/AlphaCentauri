...
public class BiomeGenHoodooValley extends ACBiome
{
    ...
    protected static final IBlockState TOP_BLOCK = Blocks.STAINED_HARDENED_CLAY.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.LIGHT_BLUE);
    protected static final IBlockState FILLER = Blocks.STAINED_HARDENED_CLAY.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.SILVER );
    
	private IBlockState[] clayBands;
    private long worldSeed;
    private NoiseGeneratorPerlin clayBandsOffsetNoise;
    private boolean hasForest = true;
    
	public BiomeGenHoodooValley(Biome.BiomeProperties properties)
	{
		super(properties);
	...
	public void genTerrainBlocks(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z, double noiseVal)
    {
        ...
        IBlockState iblockstate = PURPLE_HARDENED_CLAY;
        ...
        for (int j1 = 255; j1 >= 0; --j1)
        {
            ...
            else if (i1 < 15)
            {
                ...
                else if (iblockstate1.getBlock() == ModBlocks.acStone)
                {
                    if (l == -1)
                    {
                        flag1 = false;
                        ...
                        {
                            iblockstate = PURPLE_HARDENED_CLAY;
                        ...
                        if (j1 >= i2 - 1)
                        {
                            ...
                            else if (j1 > i2 + 3 + k)
                            {
                                ...
                                if (j1 >= 64 && j1 <= 127)
                                {
                                    if (flag)
                                    {
                                        iblockstate2 = BLUE_HARDENED_CLAY;
                                    }
                                    else
                                    {
                                ...
                                {
                                    iblockstate2 = GRAY_HARDENED_CLAY;
                                }
                        ...
                        else
                        {
                            ...
                            {
                                chunkPrimerIn.setBlockState(l1, j1, k1, GRAY_HARDENED_CLAY);
                            }
                        }
                    }
                    else if (l > 0)
	...
	public void generateBands(long p_150619_1_)
    {
        ...
        Arrays.fill(this.clayBands, BLUE_HARDENED_CLAY);
        ...
        for (int l1 = 0; l1 < 64; ++l1)
        {
            ...
            if (l1 < 64)
            {
                this.clayBands[l1] = GRAY_HARDENED_CLAY;
            }
        }
        ...
        for (int i = 0; i < i2; ++i)
        {
            ...
            {
                this.clayBands[k + l] = PURPLE_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW);
            }
        }
        ...
        for (int k2 = 0; k2 < j2; ++k2)
        {
            ...
            {
                this.clayBands[l3 + i1] = PURPLE_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.LIGHT_BLUE);
            }
        }
        ...
        for (int j3 = 0; j3 < l2; ++j3)
        {
            ...
            {
                this.clayBands[k4 + j1] = PURPLE_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.MAGENTA);
            }
        }
        ...
        for (int l4 = 0; l4 < k3; ++l4)
        {
            ...
            {
                this.clayBands[j4 + k1] = PURPLE_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.WHITE);

                if (j4 + k1 > 1 && random.nextBoolean())
                {
                    this.clayBands[j4 + k1 - 1] = PURPLE_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.SILVER);
                }
