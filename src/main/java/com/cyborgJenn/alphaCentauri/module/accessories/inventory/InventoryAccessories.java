package com.cyborgJenn.alphaCentauri.module.accessories.inventory;
...
import com.cyborgJenn.alphaCentauri.core.network.PacketSyncAccessory;
...
public class InventoryAccessories implements IInventory{
	...
	public void syncSlotToClients(int slot)
	{
		try
		{
			if (AlphaCentauri.proxy.getClientWorld() == null)
			{
