...
public class CommandKill extends Command{
	...
	public static class EntityDummy extends Entity {
		...
		public EntityDummy(String username) {
			super(AlphaCentauri.server.worldServers[0]);
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		EntityPlayer player = args.length < 1 ? getCommandSenderAsPlayer(sender) : AlphaCentauri.server.getPlayerList().getPlayerByUsername(args[0]);
		...
		//TODO FIX notifyOperators(sender, this, "Killing "+player.getName());
